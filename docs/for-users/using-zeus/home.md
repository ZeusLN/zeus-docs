...
- On the left top corner we have the access to settings and accounts.
...
- At the bottom, we have the access to transactions log (the small arrow ^), access to LN channels management and the home (bank) button.
