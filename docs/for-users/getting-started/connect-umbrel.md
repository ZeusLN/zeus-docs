...
## Connect with LND/CLN interface, using Tor or clearnet (domain/IP) network
...
## Connect with LND interface, using LNC
...
## Connect with LND/CLN interface, using Tailscale network.**
